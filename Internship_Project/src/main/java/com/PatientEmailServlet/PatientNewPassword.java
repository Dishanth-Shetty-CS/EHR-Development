...
@WebServlet("/PatientNewPassword")
public class PatientNewPassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (newPassword != null && confPassword != null && newPassword.equals(confPassword)) {
            try {
                ...
                PreparedStatement pst = con.prepareStatement("UPDATE registered_users SET password = ? WHERE email_address = ?");
