...
<head>
  ...
  <title>Aarogya Healthcare - Easily store and access patient records</title>
...
<body>
  <aside id="contact-header">
    ...
    <a href="mailto:aarogyahealthcare@gmail.com">aarogyahealthcare311@gmail.com</a>
  ...
  <header id="index-header"> 
    ...
    <nav>
      ...
      <button onclick="window.location.href='PatientRegister.jsp'">Patient Register</button>
      <button onclick="window.location.href='PatientLogin.jsp'">Patient Login</button>
      <button onclick="window.location.href='DoctorLogin.jsp'">Doctor Login</button>
    </nav>    
  </header>  
  ...
  <section id="bg-img">
    <div class="container" id="home">      
      ...
      <button onclick="window.location.href='PatientLogin.jsp'">Get Started</button>
    </div>
  </section>
  ...
  <main id="main">    
    ...
    <section id="about-section">
      ...
      <div id="about-info">        
        <b>About Aarogya Healthcare: Your Trusted Partner in Hospital Management</b>       
        <p>
          Aarogya Healthcare is a leading provider of comprehensive Hospital Management Systems
          (HMS) designed to streamline operations, enhance patient care, and empower healthcare 
          institutions.
        </p>
        ...
        <p>Our Aarogya HMS goes beyond simple record-keeping, offering a robust suite of 
        ...
        <p>
          Experience the transformative power of a comprehensive HMS. Contact Aarogya 
          Healthcare today and discover how our solutions can empower your hospital to 
