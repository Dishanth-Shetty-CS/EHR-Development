...
<%
	...
	String message="";
	String sql = "SELECT email_address, password from registered_users";
	boolean found = false;
	...
	try {
	      ...
	      while (rs.next()) {          
	          ...
	          if (retrieved_email_address.equals(email_address) && retrieved_password.equals(hashedPassword)) {
	        	  response.sendRedirect("../User-Interfaces/patient_interface.jsp");
	        	  found = true; 
	        	  break;
	          }
	      }
	      ...
	      if (!found) { 
	    	  response.sendRedirect("PatientUnableToLogin.jsp");
	      }
