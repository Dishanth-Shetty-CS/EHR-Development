...
<div class="query-records-container" style="border-top-left-radius: 10px;">					
	<table>
		...
		<%
		String newAppointments = "SELECT * FROM appointment_records WHERE appointment_type = \"" + dept + "\" AND appointment_status = \"Visited\" OR appointment_type = \"" + dept + "\" AND appointment_status = \"Cancelled\" OR appointment_type = \"" + dept + "\" AND appointment_status = \"Not Visited\"";
